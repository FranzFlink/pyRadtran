    ...
    for surface_type, description in test_cases:
        ...
        if surface_type is not None:
            ...
            if has_library and has_type:
                print(f"✓ PASS: Found 'brdf_rpv_library IGBP' and 'brdf_rpv_type {surface_type}'")
...
def test_interface_propagation():
    ...
    try:
        ...
        ds = xr.Dataset(
            ...
            data_vars={
                'surface_type': ('time', [5, 12, 17])  # Different IGBP types
            }
        )
        ...
        if 'surface_type_var' in params:
            ...
            print("✗ FAIL: execute_simulation_batch missing 'surface_type_var' parameter")
            return False
