...
from pyradtran.io import ParsedOutput, OutputType, OutputToXarray
...
def test_execute_simulation_batch(mock_as_completed, mock_executor_class, minimal_config, test_dataset):
...
def test_run_single_simulation_unified(mock_parser_class, mock_simulation_class, minimal_config):
...
def test_run_pyradtran_simulation(mock_to_xarray, mock_load_config, mock_saver_class, mock_execute, mock_loader_class, minimal_config, test_dataset):
...
@patch('pyradtran.interface.load_config')
@patch('pyradtran.interface.OutputToXarray')
def test_pyradtran_accessor(mock_to_xarray, mock_load_config, mock_saver_class, mock_execute, minimal_config, test_dataset):
